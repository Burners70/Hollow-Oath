"use strict";
/* =============================================================================
   js/render.js — all drawing. WHAT IS IN HERE, in file order.

   Grep a `/* ===== title ===== *\/` banner to jump; every function below sits
   under one of them. This index exists so a session can Read the ~200 lines it
   needs instead of the whole 5k-line file — keep it in step when you add a
   section. Nothing here mutates game state: this file draws what update.js
   decided.

     perf helpers .......................... glowSprite drawGlow glowStroke
     camera and the render() dispatch ...... zoomLevel render worldTransform
     terrain tile cache, biome palettes .... buildHeightTile getTiles
                                             invalidateTiles biomePal
     the world pass ........................ drawWorld drawWaves
     darkness and punched lights ........... drawDarkness darkPunchSprite
     ship, drone, landing guide ............ drawShip drawResupplyDrone
                                             drawLandingGuide
     Scion figures ......................... doidFigure drawOid
     scenery and biome ornaments ........... drawScenery drawBoulder drawReed
                                             drawLantern drawSpire drawDune
                                             drawHedge drawTree drawBuilding
     wrecks ................................ drawWreckM drawWreckS
                                             tornHullEdge wreckCant
     pads, lifts and shrines ............... drawSurfacePad drawLift drawShrine
     AMS MERCY — hull, hangar, bays ........ drawMothership drawHangar
                                             drawBayDoors drawTractorBeam
     the twin, the decoy, the Solace ....... drawMercySplit drawDecoyMercy
                                             drawSolaceDeath
     the beacon ............................ drawBeacon
     HUD, health and the ECG ............... drawHUD drawBar drawECG
                                             drawHudGuide
     title and help ........................ drawTitle drawHelpMenu
     the codex ............................. drawCodex drawCodexMinds
                                             drawCodexArchive updateCodex
     intro art and the intro screen ........ iShip iDoid iRidge drawIntroScreen
     briefings ............................. drawBrief paginateLines
     X1 — the HOW TO FLY guide ............. drawGuide drawGuideArt
     X3 — the first-play fork .............. drawFork
     cards, coach, sector clear ............ drawCardPanel drawCoach drawClear
     pause, confirm, settings .............. drawPause drawConfirm drawSettings
     endings and game over ................. drawGameOver drawEnding drawWin
                                             drawFireEnding drawCenter

   The `window.__doids` test/debug handle used to live at the bottom of this
   file; it is now js/debug.js, loaded straight after this one.
   ============================================================================= */
/* ================= render ================= */
...
/* ===== camera and the render() dispatch ========================================== */
function zoomLevel() {
...
/* ===== terrain tile cache and biome palettes ===================================== */
...
/* ===== the ship, the drone and the landing guide ================================= */
...
/* ===== the finale twin, the decoy and the Solace ================================= */
...
/* ===== intro art and the intro screen ============================================ */
...
/* ===== card panels, coach and sector clear ======================================= */
...
function drawClear(now) {
  ...
  /* V·pacifism — print what was actually PAID, not a constant. The award has
     ...
     flat +2000 was found to lose to shooting on the late, heavily armed
     sectors; this line went on promising 2000, so the one screen that tells a
     player restraint was worth it under-reported it by ~1,700 exactly where
     the pacifist run is hardest. */
  const hip = (level.firedShots === 0
    ? "PRIMUM NON NOCERE — Hippocratic bonus +" + noFireAward(level) + "\n" : "") +

...
Tracks playtesters for the TestFlight rounds referenced in
`docs/APP_STORE_ROADMAP.md` (Bundle O6 — internal build, then a 5–10 player
external round).

> **No email addresses in this file.** Testers' contact details live in the
> App Store Connect external test group (the only place that actually needs
...
- `Approached` — invited to test, awaiting a confirmed yes
- `Agreed` — confirmed, will test

The **TestFlight** column records when the App Store Connect beta invite was sent.

| Name | Status | TestFlight |
|------|--------|------------|
| Liam McKenzie | Agreed | Invited 2026-07-22 |
| Joe Tipping | Agreed | Invited 2026-07-22 |
| Terry Grey | Agreed | Invited 2026-07-22 |
| Phil Burnett | Agreed | Invited 2026-07-22 |
| Rachel Burnett | Agreed | Invited 2026-07-22 |
| Richard Lowther | Agreed | Invited 2026-07-22 |
